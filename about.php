...
<p id="aboutTitle" style="font-family:'Dancing Script';font-size:13vh;color: #fff;text-shadow: 2px 2px 4px rgba(0, 0, 0, 1);-webkit-margin-before: 1em;-webkit-margin-after: 5%;">About Us</p>
</div>
...
<div id="left" style="float:left; width:25%; margin-left:16%;">
<img src="/images/author_3.jpg" style="margin:0 auto;padding-top:50px; padding-left:15%; height: 60vh; max-height: 100%;">
</div>

<div id="right" style="width:40%; margin-left:50vw; padding-top:32vh; font-size:1.9vh;">
<p> Charlotte and Tim are the faces behind Fill My Macros. (Actually it's mainly Charlotte - Tim is just kind of there.) They're die-hard gym rats wandering through life lifting lots of heavy weights.</p>
<p> Charlotte is 5'0 and as a result tracks her macros so she doesn't balloon to the size of a small country. She often finds herself with no idea what
to eat at the end of the day or when she's planning out the next days macros, and forever finds herself googling 'high protein snacks'.</p>
<p> Fill My Macros is designed to be a solution to her (and hopefully other people's) problem. We hope it inspires you, or at the very least, stops you from 
raiding your fridge and cupboards hopelessly trying to avoid the doughnuts. </p>
</div>
