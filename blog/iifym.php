...
<html>
<head>
<title>Fill My Macros - Blog</title>
...
<div class="Container" style="height:55vh; margin-bottom: -20px;">
...
<div style="padding-bottom:0.25em;margin: 0 auto;display:block;text-align:center;vertical-align: middle;padding-top:5%;">
<p id="aboutTitle" style="font-family:'Dancing Script';font-size:13vh;color: #fff;text-shadow: 2px 2px 4px rgba(0, 0, 0, 1);-webkit-margin-before: 0em;-webkit-margin-after: 0em; margin-top:0em; margin-bottom:0em;">What is IIFYM?</p>
<p style="font-size:3.5vh;color: #fff;text-shadow: 2px 2px 4px rgba(0, 0, 0, 1);-webkit-margin-before: 0.5em;-webkit-margin-after: 0em; margin-top:0em; margin-bottom:0em;">The elusive world of 'If It Fits Your Macros' dieting</p>
<p style="font-size:2vh;color: #fff;text-shadow: 2px 2px 4px rgba(0, 0, 0, 1);-webkit-margin-before: 1em;-webkit-margin-after: 5%;">Posted 20/02/2017 by Charlotte</p>
</div>

</div>

<div id="about" style="height:80vh;">
<div id="blogtext" style="width:40vw; height:80%; margin:0 auto; text-align:left; padding-top:100px;">
<p>Coming soon...</p>
</div>
